	...
	render() {
		...
		return (
			<div>
				...
				{/* {renderHTML(JSON.stringify(this.props.data["codeOfConductMessage"]))} */}
				{/* {renderHTML(this.props.data["codeOfConductMessage"])} */}
				{renderHTML(String(this.props.data["codeOfConductMessage"]))}
